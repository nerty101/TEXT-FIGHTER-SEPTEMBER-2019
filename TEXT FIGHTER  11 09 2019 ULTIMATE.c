...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, hypsp3 = 0, wnctrecA = 0, prntcor = 0, a = 0;
...
dice5 = (rand() % 28 + (diflev + cpusp + a));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 29 -1
...
if (new6 > 0)
printf("     You have a new Consecutive Match Win Record!\n", wnctrec7);
if (((ctr < 7) && (cpusp < 2)) && (new6 > 0) || ((ctr < 7) && (new6 < 1) && (cpusp > 1)) || ((ctr < 7) && (new6 > 0) && (cpusp > 1)) || ((ctr > 6) && (new6 < 1) && (cpusp < 2)))
printf("\n");
if (((cpusp > 1) && (ctr > 6) && (new6 < 1)) || ((ctr > 6) && (new6 > 0) && (cpusp > 1)) || ((ctr < 7) && (new6 < 1) && (cpusp < 2)))
printf("\n");
if (cpusp > 1)
...
if ((cpusp > 1) && (ctr > 5))
printf("\n");
if (((cpusp < 2) && (ctr < 6) && (new6 < 1)) || ((ctr > 5) && (cpusp < 2) && (new6 < 1)) || ((ctr > 6) && (new6 > 0) && (cpusp < 2)))
printf("\n");
...
{
diceE = (rand() % 24 + diflev + diceR) + 1;//maybe 28 24 26
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
diceE = (rand() % 30 + diflev) + 1;//maybe 32 0r 34 32 33
}
diceS = (rand() % 10) + 1;//6
if (diceS == 1)
{
...
diceF = (rand() % 39 + diflev + diceR) + 1; //42 40
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 51 + diflev) + 1; //54 52
}
...
diceC = (rand() % 75 + diflev) + 1; //72 73 74
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 89 + diflev + diceR) + 1; //86 87 88
}//added
if ((diceF > 29) && (diceR < 1))
{
diceS = (rand() % 12) + 1;//8
